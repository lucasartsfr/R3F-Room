...
export default function Grass(
  ...
  const {uRadius, uCircle, uInstances, uBH, uBW, uJoints, uWidthZ, uWidthX, uFlat, uHoleRadius, uHole, uSquareHole, uSquareSize, uSegment, uhillScale, uUnderWater, uUnderWaterHeight } = useControls("Grass",
     {        
        uCircle : circle,
        uRadius : {value : 16.0, step : 0.1, min : 1.0, max : 30.0},        
        uHole : hole,
        uUnderWater : underWater,
        uUnderWaterHeight : {value : 0.91, step : 0.01, min : -10.0, max : 10.0},        
        uSquareHole : true,
        uSquareSize : {
          value : {x : 0.49, y : 0.49},
          step : 0.05
  ...
  const attributeData = useMemo(() => getAttributeData(uInstances, uWidthX, uWidthZ, uFlat, uhillScale, uUnderWaterHeight), [uInstances, uWidthX, uWidthZ, uFlat, uhillScale, uUnderWaterHeight])
...
function getAttributeData(uInstances, uWidthX, uWidthZ, uFlat, uhillScale, uUnderWaterHeight) {
